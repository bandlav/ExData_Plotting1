plot4<-function(){
  ...
  plot(tff$Time,tff$Global_active_power,type='l',xlab='',ylab='Global Active Power (kilowatts)')  
  plot(tff$Time,tff$Voltage,type='l',xlab='datetime',ylab='Voltage') 
  ...
  plot(tff$Time,tff$Global_reactive_power,type='l',xlab='datetime',ylab='Global_reactive_power')
